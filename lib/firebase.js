...
import { 
  getAuth, // <<< ESSENCIAL: Garante que getAuth está importado para inicialização condicional
  createUserWithEmailAndPassword, 
  signInWithEmailAndPassword, 
  signOut as firebaseAuthSignOut, // Renomeado para evitar qualquer conflito, só para clareza interna
  onAuthStateChanged,
  initializeAuth, 
